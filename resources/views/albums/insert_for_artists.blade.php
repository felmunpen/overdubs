    ...
    <main>
        <div class="static_card" style="padding: 0.2vh 3vh;">
            ...
            <form method="GET" action=""
                style="display: grid; grid-template-columns: 1fr 1fr 1fr; column-gap: 10px; padding: 0.5vh 3vh 1vh;">
                @csrf
                <label for="album_name">&nbsp&nbsp Album name:</label>
                <input type="hidden" name="artist_name" id="artist_name" class="search" style="width: 100%;" required
                    value="<?php echo $artist?>" readonly>
                <span></span><span></span>
