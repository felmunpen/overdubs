...
// Route::get('/dashboard', function () {
//     return view('users.user_start');
// })->middleware(['auth', 'verified'])->name('dashboard');//El nombre de la uri es necesario debido a AuthenticatedSessionController->store
// ;
...
Route::post('/follow_or_unfollow', [UserController::class, 'follow_or_unfollow'])->name('follow_or_unfollow');
##########
...
##########
// Route::get('/admin/{element}', [AdminController::class, 'redirect'])->name('admin_section');
Route::get('/admin/show_users', [AdminController::class, 'show_users'])->name('show_users');
Route::get('/admin/show_albums', [AdminController::class, 'show_albums'])->name('show_albums');
Route::get('/admin/show_artists', [AdminController::class, 'show_artists'])->name('show_artists');
Route::get('/admin/show_reviews', [AdminController::class, 'show_reviews'])->name('show_reviews');
Route::get('/admin/data_report', [AdminController::class, 'data_report'])->name('data_report');
/**debería ser post*/
Route::get('/admin/users/block/{id}', [AdminController::class, 'block'])->name('admin_block');
